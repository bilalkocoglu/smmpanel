...
function PickerConstructor( ELEMENT, NAME, COMPONENT, OPTIONS ) {
    ...
    function prepareElement() {
        ...
        $ELEMENT.
            ...
            // Store the picker data by component customName.
            data(NAME, P).

            // Add the â€œinputâ€ class customName.
        ...
        P.$holder.
            ...
            on( 'click', '[data-pick], [data-nav], [data-clear], [data-close]', function() {
                ...
                var $target = $( this ),
                    ...
                    // * For IE, non-focusable elements can be state elements as well
    ...
    function prepareElementHidden() {
        ...
        P._hidden = $(
            ...
            // Create the customName using the original inputâ€™s with a prefix and suffix.
            'customName="' + name + '"' +
