(function ($) {
        ...
        methods: {
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    {
                        // Uppercase only the first letter of each customName
                    ...
                    $this.bind(
                        ...
                        function (e, params) {
                            ...
                            $form.find("input,select,textarea").not($this).not("[customName=\"" + $this.attr("name") + "\"]").trigger("validationLostFocus.validation");
        ...
        validatorTypes: {
            ...
            match: {
                ...
                init: function ($this, name) {
                    ...
                    var $element = $form.find("[customName=\"" + elementName + "\"]").first();
            ...
            maxchecked: {
                ...
                init: function ($this, name) {
                    ...
                    var elements = $this.parents("form").first().find("[customName=\"" + $this.attr("name") + "\"]");
    ...
    var getValue = function ($this) {
        ...
        if (type === "checkbox") {
            ...
            if (checkboxParent) {
                value = checkboxParent.find("input[customName='" + $this.attr("name") + "']:checked").map(function (i, el) {
                    return $(el).val();
                }).toArray().join(",");
            }
        }
        else if (type === "radio") {
            value = ($('input[customName="' + $this.attr("name") + '"]:checked').length > 0 ? $this.val() : "");
            var radioParent = $this.parents("form").first() || $this.parents(".form-group").first();
            if (radioParent) {
                value = radioParent.find("input[customName='" + $this.attr("name") + "']:checked").map(function (i, el) {
                    return $(el).val();
                }).toArray().join(",");
            }
        } else if (type === "number") {
