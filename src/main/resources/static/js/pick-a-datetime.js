...
(function(window, document, $) {
	...
	$('.pickadate-short-string').pickadate({
		weekdaysShort: ['Cts', 'Pzr', 'Pzt', 'Sa', 'Çr', 'Pe', 'Cu'],
	...
	$('.pickadate-format').pickadate({
		...
		format: 'Tarih Seçiniz : dddd, dd mmmm, yyyy',
	...
	$( '.pickadate-arrow' ).pickadate({
		monthPrev: '&larr;',
		monthNext: '&rarr;',
		weekdaysShort: [ 'Pzr', 'Pzt', 'Sa', 'Çr', 'Pe', 'Cu', 'Cts' ],
	...
	$('.pickadate-selectors').pickadate({
		...
		labelMonthSelect: 'Ay seç',
		labelYearSelect: 'Yıl seç',
		selectMonths: true,
		selectYears: true
	});
	...
	$( '.pickadate-translations' ).pickadate({
		...
		monthsShort: [ 'Oc', 'Şub', 'Mar', 'Nis', 'May', 'Haz', 'Temm', 'Agu', 'Eyl', 'Ekm', 'Kas', 'Ara' ],
		weekdaysShort: [ 'Pzr', 'Pts', 'Sal', 'Crs', 'Prs', 'Cum', 'Cts' ],
		today: 'Bugün',
		clear: 'Temizle',
		close: 'Kapat'
	});
